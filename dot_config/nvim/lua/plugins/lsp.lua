return {
  ...
  config = function()
    require('neodev').setup {
      library = {
        enabled = true, -- enable type definitions
        plugins = true, -- include plugin types
        types = true, -- include Neovim runtime types
      },
    }
    ...
    lint.linters_by_ft = {
      python = { 'flake8' }, -- Ví dụ cho Python
    }
